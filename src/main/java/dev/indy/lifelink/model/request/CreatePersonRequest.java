...
public record CreatePersonRequest(
    ...
    @Pattern(groups = ValidationGroups.OnCreate.class, regexp = Util.ALPHABETIC_REGEXP, message = "Middle name can only contain alphabetic characters")
    ...
    @Pattern(regexp = Util.ALPHABETIC_REGEXP, message = "Last name can only contain alphabetic characters")
