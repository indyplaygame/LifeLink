...
public record AddChronicDiseaseRequest(
    ...
    @Pattern(regexp = "^[a-zA-Z0-9 ',-]+$", message = "Disease name can only contain alphanumeric characters, apostrophes, commas, hyphens, and spaces")
    ...
    @Pattern(regexp = "^\\d{2}-\\d{2}-\\d{2}$", message = "Diagnosis date must be in the format DD-MM-YYYY")
